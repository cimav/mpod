...
class RankTensors():
   ...
   def SecondRankTensor(self,d11, d12, d13, d21, d22, d23, d31, d32, d33, Color,filename,res,stl_dir,createstl,createdata):
    #target = open('/var/www/MPOD/mpod.log', 'a')
    #target.write('secondranktensor ')
   ...
   def ThirdRankTensor (self,d11,d12,d13,d14,d15,d16,d21,d22,d23,d24,d25,d26,d31,d32,d33,d34,d35,d36,Color,filename,res,stl_dir,createstl,createdata):
        filename= filename
      #self.Res = res
        stldir=stl_dir
        createstl= createstl
